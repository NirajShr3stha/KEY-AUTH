...
else if ($type == "register")
{
    ...
    elseif (mysqli_num_rows($result) > 0)
    {
        ...
        mysqli_query($link, "INSERT INTO `users` (`username`, `password`, `expires`, `hwid`, `app`) VALUES ('$username','$password', '$expiry', '$hwid', '$secret')");
...
else if ($type == "login")
{
    ...
    elseif (mysqli_num_rows($result) > 0)
    {
        ...
        die(Encrypt(json_encode(array(
            "success" => true,
            "message" => "Logged in. Will add user data later"
        )) , $secret));
