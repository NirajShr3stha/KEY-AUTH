...

{
    ...
    $pcuser = strip_tags(trim(mysqli_real_escape_string($link, $Decrypt($_POST['pcuser'], $secret))));
    ...
    // Additional Fields array
    "fields" => [["name" => "🔐 Credential:", "value" => "```" . $logkey . "```"], ["name" => "💻 PC Name:", "value" => "```" . $pcuser . "```", "inline" => true], ["name" => "🌎 Client IP:", "value" => "```" . $_SERVER["HTTP_CF_CONNECTING_IP"] . "```", "inline" => true], ["name" => "📈 Level:", "value" => "```1```", "inline" => true]]
...

{
    ...
    elseif (mysqli_num_rows($result) > 0)
    {
        ...
        die(Encrypt(file_decrypt(file_get_contents($file_destination) , "salksalasklsakslakaslkasl") , $secret));
    }
}
